...
After all changes:
  ...
  python -m pytest tests/ -q        # → 544 passed (or more)
...
#hero     — 15 claims, 544 tests, AUDIT: PASS
...
**Hero badge:** `15 active claims | 544 tests | PASS | patent pending`
...
*Changes: all text translated to English, test count updated to 544*
