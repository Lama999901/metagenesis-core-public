...
CONTENT_CHECKS = {
    "llms.txt": {
        ...
        "required": ["2012", "v0.9", "20 active claims", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
    ...
    "AGENTS.md": {
        "banned": ["16 agent checks", "17 agent checks", "18 agent checks", "19 agent checks", "906 tests", "906 passed", "966 tests", "966 passed", "1050 tests", "1050 passed", "1125 tests", "1125 passed", "1273 tests", "1273 passed", "1634 tests", "1634 passed", "1750 tests", "1750 passed", "1753 tests", "1753 passed"],
        "required": ["2012", "v0.9.0", "20 claims", "20 agent checks"],
    },
    "CONTRIBUTING.md": {
        "banned": ["223 passed", "295 passed", "511 passed", "526 passed", "544 passed", "586 passed", "595 passed", "601 passed", "839 passed", "906 passed", "966 passed", "1050 passed", "1125 passed", "1198 passed", "1273 passed", "1634 passed", "1750 passed", "1753 passed", "601", "ALL 10 TESTS", "3 verification layers"],
        "required": ["2012", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        "banned": ["version: 0.2", "version: 0.3", "version: 0.4", "version: 0.5", "version: 0.6", "version: 0.7", "three independent", "601", "966 adversarial", "1050 adversarial", "1125 adversarial", "1273 adversarial", "1313 adversarial", "1634 adversarial", "1750 adversarial", "1753 adversarial"],
        "required": ["version: 0.9", "five independent", "2012"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ARCHITECTURE.md": {
        "banned": ["282 tests", "511 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "1634 tests", "1750 tests", "1753 tests", "Architecture v0.2", "Three verification layers"],
        "required": ["2012 tests", "Five verification layers"],
    },
    "docs/ROADMAP.md": {
        "banned": ["Current version: 0.2", "Current version: 0.3", "Current version: 0.4", "282 adversarial", "595 adversarial", "601 adversarial", "906 adversarial", "966 adversarial", "1050 adversarial", "1125 adversarial", "1273 adversarial", "1313 adversarial", "1634 adversarial", "1750 adversarial", "1753 adversarial"],
        "required": ["0.9.0", "2012 adversarial"],
    },
    "ppa/README_PPA.md": {
        "banned": ["282 tests", "511 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "1634 tests", "1750 tests", "1753 tests", "Current state (2026-03-17)"],
        "required": ["2012 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "README.md": {
        ...
        "required": ["2012", "8 innovations", "20 agent checks", "The 20 Checks", "ALL 20 CHECKS PASSED", "20 claims", "PHYS-01", "PHYS-02", "Tests-2012%20passing"],
    },
    "index.html": {
    ...
    "paper.md": {
        "banned": ["389 adversarial", "511 adversarial", "526 adversarial", "544 adversarial", "595 adversarial", "601 adversarial", "906 adversarial", "966 adversarial", "1050 adversarial", "1125 adversarial", "1198 adversarial", "1273 adversarial", "1313 adversarial", "1634 adversarial", "1750 adversarial", "1753 adversarial", "17 March 2026", "7 domains", "6.022e23"],
        "required": ["2012 adversarial", "18 March 2026", "8 domains"],
    },
    "reports/known_faults.yaml": {
        "banned": ["282 tests", "295 passed", "295 tests", "511 tests", "511 passed", "526 tests", "544 tests", "544 passed", "595 tests", "595 passed", "601 tests", "601 passed", "906 tests", "906 passed", "966 tests", "966 passed", "1050 tests", "1050 passed", "1125 tests", "1125 passed", "1273 tests", "1273 passed", "1634 tests", "1634 passed", "1750 tests", "1750 passed", "1753 tests", "1753 passed"],
        "required": ["2012 tests", "2012 passed"],
    },
    "CLAUDE.md": {
        "banned": ["10-test proof", "12 counters", "15 claims", "16 claims", "17 claims", "18 claims", "19 claims", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1273 tests", "1634 tests", "1750 tests", "1753 tests"],
        "required": ["13-test proof", "8 innovations", "20 claims", "2012 tests"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        "banned": ["271 tests", "295 tests", "526 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "1634 tests", "1750 tests", "1753 tests", "3 verification layers", "MVP v0.2", "ALL 10 TESTS", "MVP v0.6"],
        "required": ["2012 tests", "5 verification layers", "MVP v0.9", "ALL 13 TESTS"],
    },
