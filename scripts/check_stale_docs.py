...
CRITICAL_FILES = {
    ...
    "docs/CLIENT_SECURITY.md": {
        "tracks": ["scripts/mg_onboard.py", "scripts/mg_contribute.py", "scripts/mg_payment_tracker.py"],
        "description": "Client security and privacy documentation",
    },
}
...
CONTENT_CHECKS = {
    "llms.txt": {
        "banned": ["595 passing", "595 passed", "16 evolution checks", "Claims: 18", "Domains: 7 (", "906 passed", "906 tests", "966 passed", "966 tests", "1050 passed", "1050 tests", "1125 passed", "1125 tests", "1273 passed", "1273 tests", "1313 passed", "1313 tests", "1634 passed", "1634 tests", "1750 passed", "1750 tests", "1753 passed", "1753 tests", "2380 tests", "2063 passed", "2063 tests", "2380 tests", "2078 passed", "2078 tests", "2380 passed", "2380 tests", "2380 passed", "2380 tests", "2407 passed", "2407 tests", "2423 passed", "2423 tests"],
        "required": ["2428", "v1.0", "20 domain verification templates", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
        "banned": ["595 passing", "595 passed", "v0.6.0", "Domains | 7", "906 passed", "906 tests", "966 passed", "966 tests", "1050 passed", "1050 tests", "1125 passed", "1125 tests", "1273 passed", "1273 tests", "1313 passed", "1313 tests", "1634 passed", "1634 tests", "1750 passed", "1750 tests", "1753 passed", "1753 tests", "2063 passed", "2063 tests", "2078 passed", "2078 tests", "2407 passed", "2407 tests"],
        "required": ["2428", "v1.0"],
    },
    "AGENTS.md": {
        "banned": ["16 agent checks", "17 agent checks", "18 agent checks", "19 agent checks", "906 tests", "906 passed", "966 tests", "966 passed", "1050 tests", "1050 passed", "1125 tests", "1125 passed", "1273 tests", "1273 passed", "1634 tests", "1634 passed", "1750 tests", "1750 passed", "1753 tests", "1753 passed", "2063 tests", "2063 passed", "2380 tests", "2380 passed", "2380 tests", "2380 passed", "2407 tests", "2407 passed", "v0.9.0"],
        "required": ["2428", "v1.0.0-rc1", "20 claims", "22 agent checks"],
    },
    "CONTRIBUTING.md": {
        "banned": ["223 passed", "295 passed", "511 passed", "526 passed", "544 passed", "586 passed", "595 passed", "601 passed", "839 passed", "906 passed", "966 passed", "1050 passed", "1125 passed", "1198 passed", "1273 passed", "1634 passed", "1750 passed", "1753 passed", "2063 passed", "2380 passed", "2407 passed", "601", "ALL 10 TESTS", "3 verification layers"],
        "required": ["2428", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        "banned": ["version: 0.2", "version: 0.3", "version: 0.4", "version: 0.5", "version: 0.6", "version: 0.7", "version: 0.8", "three independent", "601", "966 adversarial", "1050 adversarial", "1125 adversarial", "1273 adversarial", "1313 adversarial", "1634 adversarial", "1750 adversarial", "1753 adversarial", "2063 adversarial", "2078 adversarial", "2380 adversarial", "2380 adversarial", "2380 adversarial", "2407 adversarial"],
        "required": ["version: 1.0", "five independent", "2428"],
    },
    "docs/PROTOCOL.md": {
        "banned": ["MVP v0.2", "MVP v0.3", "MVP v0.4", "MVP v0.5", "Three verification layers", "5 patentable"],
        "required": ["(MVP) v1.0", "Five verification layers", "8 innovations"],
    },
    "docs/AGENT_SYSTEM.md": {
        "banned": ["15 checks", "15-check", "17 checks", "17-check", "18 checks", "18-check", "19 checks", "19-check"],
        "required": ["Level 1", "Level 2", "Level 3", "AGENT-DRIFT-01", "20 checks"],
    },
    "docs/ARCHITECTURE.md": {
        "banned": ["282 tests", "511 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "1634 tests", "1750 tests", "1753 tests", "2063 tests", "2407 tests", "Architecture v0.2", "Three verification layers"],
        "required": ["2428 tests", "Five verification layers"],
    },
    "ppa/README_PPA.md": {
        "banned": ["282 tests", "511 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "1634 tests", "1750 tests", "1753 tests", "2063 tests", "2407 tests", "Current state (2026-03-17)"],
        "required": ["2428 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "README.md": {
        "banned": ["295 passing", "511 passing", "526 passing", "544 passing", "595 passing", "601 passing", "601", "6 innovations", "7 innovations", "8 innovations", "9 innovations", "14 agent checks", "17 agent checks", "18 agent checks", "19 agent checks", "The 14 Checks", "The 17 Checks", "The 18 Checks", "The 19 Checks", "ALL 14 CHECKS PASSED", "ALL 17 CHECKS PASSED", "ALL 18 CHECKS PASSED", "ALL 19 CHECKS PASSED", "10 automated", "18 verified claims", "17 autonomous", "15 Active Verification", "Tests-608%20passing", "Tests-651%20passing", "Tests-734%20passing", "Tests-906%20passing", "906 passing", "Tests-966%20passing", "966 passing", "Tests-1050%20passing", "1050 passing", "Tests-1125%20passing", "1125 passing", "Tests-1273%20passing", "Tests-1313%20passing", "1273 passing", "1313 passing", "Tests-1634%20passing", "1634 passing", "Tests-1750%20passing", "1750 passing", "Tests-1753%20passing", "1753 passing", "Tests-2063%20passing", "2063 passing", "2078 passing", "2380 passing", "Tests-2407%20passing", "2407 passing", "21/21", "20 agent checks", "ALL 20 CHECKS PASSED", "The 20 Checks", "21 agent checks", "ALL 21 CHECKS PASSED", "The 21 Checks", "122 agent learning sessions", "11 recurring failure patterns", "Zero ghost patterns remaining"],
        "required": ["2428", "10 Innovations", "22 agent checks", "ALL 22 CHECKS PASSED", "20 claims", "PHYS-01", "PHYS-02", "Tests-2428%20passing"],
    },
    "index.html": {
        "banned": ["<span>10</span>", "<span>17</span>", "<span>21</span>", "14 active domain claims", "Fourteen</span> claims", "Fifteen</span> claims", "15 active domain claims", "18 active domain claims", "Eighteen</span> claims", "hv\">v0.7.0", "hv\">v0.8.0", "hv\">v0.9.0"],
        "required": ["<span>22</span>", "20 active domain claims", "Twenty</span> claims", "hv\">v1.0.0-rc1"],
    },
    "paper.md": {
        "banned": ["389 adversarial", "511 adversarial", "526 adversarial", "544 adversarial", "595 adversarial", "601 adversarial", "906 adversarial", "966 adversarial", "1050 adversarial", "1125 adversarial", "1198 adversarial", "1273 adversarial", "1313 adversarial", "1634 adversarial", "1750 adversarial", "1753 adversarial", "2063 adversarial", "2078 adversarial", "2407 adversarial", "17 March 2026", "7 domains", "6.022e23"],
        "required": ["2428 adversarial", "18 March 2026", "8 domains"],
    },
    "reports/known_faults.yaml": {
        "banned": ["282 tests", "295 passed", "295 tests", "511 tests", "511 passed", "526 tests", "544 tests", "544 passed", "595 tests", "595 passed", "601 tests", "601 passed", "906 tests", "906 passed", "966 tests", "966 passed", "1050 tests", "1050 passed", "1125 tests", "1125 passed", "1273 tests", "1273 passed", "1634 tests", "1634 passed", "1750 tests", "1750 passed", "1753 tests", "1753 passed", "2063 tests", "2063 passed", "2407 tests", "2407 passed", "2423 tests", "2423 passed"],
        "required": ["2428 tests", "2428 passed"],
    },
    "CLAUDE.md": {
        "banned": ["10-test proof", "12 counters", "15 claims", "16 claims", "17 claims", "18 claims", "19 claims", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1273 tests", "1634 tests", "1750 tests", "1753 tests", "2063 tests", "2407 tests"],
        "required": ["13-test proof", "8 innovations", "20 claims", "2428 tests", "v1.0.0-rc1"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        "banned": ["271 tests", "295 tests", "526 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "1634 tests", "1750 tests", "1753 tests", "2063 tests", "2407 tests", "3 verification layers", "MVP v0.2", "ALL 10 TESTS", "MVP v0.6"],
        "required": ["2428 tests", "5 verification layers", "MVP v1.0", "ALL 13 TESTS"],
    },
    ...
    "scripts/agent_evolution.py": {
        "banned": [],
        "required": ["check_signals", "check_chronicle", "check_pr_review", "check_impact", "check_semantic_audit", "v1.0.0-rc1"],
    },
