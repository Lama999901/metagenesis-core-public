...
CONTENT_CHECKS = {
    ...
    "README.md": {
        ...
        "required": ["608", "8 innovations", "18 agent checks", "The 18 Checks", "ALL 18 CHECKS PASSED", "20 claims", "PHYS-01", "PHYS-02"],
    },
    "index.html": {
    ...
    "paper.md": {
        ...
        "required": ["608 adversarial", "18 March 2026"],
    },
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        ...
        "required": ["608 tests", "5 verification layers", "MVP v0.8", "ALL 13 TESTS"],
    },
