...
CONTENT_CHECKS = {
    "llms.txt": {
        ...
        "required": ["1634", "v0.9", "20 active claims", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
    ...
    "AGENTS.md": {
        ...
        "required": ["1634", "v0.9.0", "20 claims", "19 agent checks"],
    },
    "CONTRIBUTING.md": {
        ...
        "required": ["1634", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        ...
        "required": ["version: 0.9", "five independent", "1634"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ARCHITECTURE.md": {
        ...
        "required": ["1634 tests", "Five verification layers"],
    },
    "docs/ROADMAP.md": {
        ...
        "required": ["0.9.0", "1634 adversarial"],
    },
    "ppa/README_PPA.md": {
        ...
        "required": ["1634 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "README.md": {
        ...
        "required": ["1634", "8 innovations", "19 agent checks", "The 19 Checks", "ALL 19 CHECKS PASSED", "20 claims", "PHYS-01", "PHYS-02", "Tests-1634%20passing"],
    },
    "index.html": {
    ...
    "paper.md": {
        ...
        "required": ["1634 adversarial", "18 March 2026", "8 domains"],
    },
    "reports/known_faults.yaml": {
        ...
        "required": ["1634 tests", "1634 passed"],
    },
    "CLAUDE.md": {
        ...
        "required": ["13-test proof", "8 innovations", "20 claims", "1634 tests"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        ...
        "required": ["1634 tests", "5 verification layers", "MVP v0.9", "ALL 13 TESTS"],
    },
