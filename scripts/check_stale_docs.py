...
CONTENT_CHECKS = {
    "llms.txt": {
        "banned": ["595 passing", "595 passed", "16 evolution checks", "Claims: 18", "Domains: 7 (", "906 passed", "906 tests", "966 passed", "966 tests", "1050 passed", "1050 tests", "1125 passed", "1125 tests", "1273 passed", "1273 tests"],
        "required": ["1313", "v0.8", "20 active claims", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
        "banned": ["595 passing", "595 passed", "v0.6.0", "Domains | 7", "906 passed", "906 tests", "966 passed", "966 tests", "1050 passed", "1050 tests", "1125 passed", "1125 tests", "1273 passed", "1273 tests"],
        "required": ["1313", "v0.8"],
    },
    "AGENTS.md": {
        "banned": ["16 agent checks", "17 agent checks", "18 agent checks", "906 tests", "906 passed", "966 tests", "966 passed", "1050 tests", "1050 passed", "1125 tests", "1125 passed", "1273 tests", "1273 passed"],
        "required": ["1313", "v0.8.0", "20 claims", "19 agent checks"],
    },
    "CONTRIBUTING.md": {
        "banned": ["223 passed", "295 passed", "511 passed", "526 passed", "544 passed", "586 passed", "595 passed", "601 passed", "839 passed", "906 passed", "966 passed", "1050 passed", "1125 passed", "1198 passed", "1273 passed", "601", "ALL 10 TESTS", "3 verification layers"],
        "required": ["1313", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        "banned": ["version: 0.2", "version: 0.3", "version: 0.4", "version: 0.5", "version: 0.6", "version: 0.7", "three independent", "601", "966 adversarial", "1050 adversarial", "1125 adversarial", "1273 adversarial"],
        "required": ["version: 0.8", "five independent", "1313"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ARCHITECTURE.md": {
        "banned": ["282 tests", "511 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "Architecture v0.2", "Three verification layers"],
        "required": ["1313 tests", "Five verification layers"],
    },
    "docs/ROADMAP.md": {
        "banned": ["Current version: 0.2", "Current version: 0.3", "Current version: 0.4", "282 adversarial", "595 adversarial", "601 adversarial", "906 adversarial", "966 adversarial", "1050 adversarial", "1125 adversarial", "1273 adversarial"],
        "required": ["0.8.0", "1313 adversarial"],
    },
    "ppa/README_PPA.md": {
        "banned": ["282 tests", "511 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "Current state (2026-03-17)"],
        "required": ["1313 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "paper.md": {
        "banned": ["389 adversarial", "511 adversarial", "526 adversarial", "544 adversarial", "595 adversarial", "601 adversarial", "906 adversarial", "966 adversarial", "1050 adversarial", "1125 adversarial", "1198 adversarial", "1273 adversarial", "17 March 2026"],
        "required": ["1313 adversarial", "18 March 2026"],
    },
    "reports/known_faults.yaml": {
        ...
        "required": ["1313 tests", "1313 passed"],
    },
    "CLAUDE.md": {
        "banned": ["10-test proof", "12 counters", "15 claims", "16 claims", "17 claims", "18 claims", "19 claims", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1273 tests"],
        "required": ["13-test proof", "8 innovations", "20 claims", "1313 tests"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        "banned": ["271 tests", "295 tests", "526 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "1198 tests", "1273 tests", "3 verification layers", "MVP v0.2", "ALL 10 TESTS", "MVP v0.6"],
        "required": ["1313 tests", "5 verification layers", "MVP v0.8", "ALL 13 TESTS"],
    },
