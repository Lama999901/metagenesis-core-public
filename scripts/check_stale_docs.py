...
CONTENT_CHECKS = {
    "llms.txt": {
        ...
        "required": ["1321", "v0.9", "20 active claims", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
    ...
    "AGENTS.md": {
        ...
        "required": ["1321", "v0.9.0", "20 claims", "19 agent checks"],
    },
    "CONTRIBUTING.md": {
        ...
        "required": ["1321", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        ...
        "required": ["version: 0.9", "five independent", "1321"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ARCHITECTURE.md": {
        ...
        "required": ["1321 tests", "Five verification layers"],
    },
    "docs/ROADMAP.md": {
        ...
        "required": ["0.9.0", "1321 adversarial"],
    },
    "ppa/README_PPA.md": {
        ...
        "required": ["1321 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "reports/known_faults.yaml": {
        ...
        "required": ["1321 tests", "1321 passed"],
    },
    "CLAUDE.md": {
        ...
        "required": ["13-test proof", "8 innovations", "20 claims", "1321 tests"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        ...
        "required": ["1321 tests", "5 verification layers", "MVP v0.9", "ALL 13 TESTS"],
    },
