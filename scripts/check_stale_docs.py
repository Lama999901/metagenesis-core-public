...
CONTENT_CHECKS = {
    ...
    "AGENTS.md": {
        ...
        "required": ["2063", "v0.9.0", "20 claims", "20 agent checks"],
    },
    "CONTRIBUTING.md": {
        ...
        "required": ["2063", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        ...
        "required": ["version: 0.9", "five independent", "2063"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ARCHITECTURE.md": {
        ...
        "required": ["2063 tests", "Five verification layers"],
    },
    "docs/ROADMAP.md": {
        ...
        "required": ["0.9.0", "2063 adversarial"],
    },
    "ppa/README_PPA.md": {
        ...
        "required": ["2063 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "paper.md": {
        ...
        "required": ["2063 adversarial", "18 March 2026", "8 domains"],
    },
    "reports/known_faults.yaml": {
        ...
        "required": ["2063 tests", "2063 passed"],
    },
    "CLAUDE.md": {
        ...
        "required": ["13-test proof", "8 innovations", "20 claims", "2063 tests"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        ...
        "required": ["2063 tests", "5 verification layers", "MVP v0.9", "ALL 13 TESTS"],
    },
