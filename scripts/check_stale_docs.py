...
CONTENT_CHECKS = {
    "llms.txt": {
        "banned": ["595 passing", "595 passed", "16 evolution checks", "Claims: 18", "Domains: 7 (", "906 passed", "906 tests", "966 passed", "966 tests", "1050 passed", "1050 tests", "1125 passed", "1125 tests", "1273 passed", "1273 tests", "1313 passed", "1313 tests"],
        "required": ["1466", "v0.9", "20 active claims", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
        "banned": ["595 passing", "595 passed", "v0.6.0", "Domains | 7", "906 passed", "906 tests", "966 passed", "966 tests", "1050 passed", "1050 tests", "1125 passed", "1125 tests", "1273 passed", "1273 tests", "1313 passed", "1313 tests"],
        "required": ["1466", "v0.9"],
    },
    "AGENTS.md": {
        ...
        "required": ["1466", "v0.9.0", "20 claims", "19 agent checks"],
    },
    "CONTRIBUTING.md": {
        ...
        "required": ["1466", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        "banned": ["version: 0.2", "version: 0.3", "version: 0.4", "version: 0.5", "version: 0.6", "version: 0.7", "three independent", "601", "966 adversarial", "1050 adversarial", "1125 adversarial", "1273 adversarial", "1313 adversarial"],
        "required": ["version: 0.9", "five independent", "1466"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ARCHITECTURE.md": {
        ...
        "required": ["1466 tests", "Five verification layers"],
    },
    "docs/ROADMAP.md": {
        "banned": ["Current version: 0.2", "Current version: 0.3", "Current version: 0.4", "282 adversarial", "595 adversarial", "601 adversarial", "906 adversarial", "966 adversarial", "1050 adversarial", "1125 adversarial", "1273 adversarial", "1313 adversarial"],
        "required": ["0.9.0", "1466 adversarial"],
    },
    "ppa/README_PPA.md": {
        ...
        "required": ["1466 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "README.md": {
        ...
        "required": ["1466", "8 innovations", "19 agent checks", "The 19 Checks", "ALL 19 CHECKS PASSED", "20 claims", "PHYS-01", "PHYS-02", "Tests-1466%20passing"],
    },
    "index.html": {
    ...
    "paper.md": {
        ...
        "required": ["1466 adversarial", "18 March 2026", "8 domains"],
    },
    "reports/known_faults.yaml": {
        ...
        "required": ["1466 tests", "1466 passed"],
    },
    "CLAUDE.md": {
        ...
        "required": ["13-test proof", "8 innovations", "20 claims", "1466 tests"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        ...
        "required": ["1466 tests", "5 verification layers", "MVP v0.9", "ALL 13 TESTS"],
    },
