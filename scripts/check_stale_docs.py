...
CONTENT_CHECKS = {
    "llms.txt": {
        ...
        "required": ["839", "v0.8", "20 active claims", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
    ...
    "AGENTS.md": {
        ...
        "required": ["839", "v0.8.0", "20 claims", "19 agent checks"],
    },
    "CONTRIBUTING.md": {
        "banned": ["223 passed", "295 passed", "511 passed", "526 passed", "544 passed", "586 passed", "595 passed", "601 passed", "779 passed", "601", "ALL 10 TESTS", "3 verification layers"],
        "required": ["839", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        "banned": ["version: 0.2", "version: 0.3", "version: 0.4", "version: 0.5", "version: 0.6", "version: 0.7", "three independent", "601"],
        "required": ["version: 0.8", "five independent", "839"],
    },
    "docs/PROTOCOL.md": {
    ...
    "README.md": {
        ...
        "required": ["839", "8 innovations", "19 agent checks", "The 19 Checks", "ALL 19 CHECKS PASSED", "20 claims", "PHYS-01", "PHYS-02", "Tests-839%20passing"],
    },
    "index.html": {
    ...
    "paper.md": {
        ...
        "required": ["839 adversarial", "18 March 2026"],
    },
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        ...
        "required": ["839 tests", "5 verification layers", "MVP v0.8", "ALL 13 TESTS"],
    },
