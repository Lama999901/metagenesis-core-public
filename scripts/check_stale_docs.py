...
CONTENT_CHECKS = {
    "llms.txt": {
        ...
        "required": ["1198", "v0.8", "20 active claims", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
    ...
    "AGENTS.md": {
        ...
        "required": ["1198", "v0.8.0", "20 claims", "19 agent checks"],
    },
    "CONTRIBUTING.md": {
        "banned": ["223 passed", "295 passed", "511 passed", "526 passed", "544 passed", "586 passed", "595 passed", "601 passed", "839 passed", "906 passed", "966 passed", "1050 passed", "1125 passed", "601", "ALL 10 TESTS", "3 verification layers"],
        "required": ["1198", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        ...
        "required": ["version: 0.8", "five independent", "1198"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ARCHITECTURE.md": {
        "banned": ["282 tests", "511 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "Architecture v0.2", "Three verification layers"],
        "required": ["1198 tests", "Five verification layers"],
    },
    "docs/ROADMAP.md": {
        ...
        "required": ["0.8.0", "1198 adversarial"],
    },
    "ppa/README_PPA.md": {
        "banned": ["282 tests", "511 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "Current state (2026-03-17)"],
        "required": ["1198 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "README.md": {
        ...
        "required": ["1198", "8 innovations", "19 agent checks", "The 19 Checks", "ALL 19 CHECKS PASSED", "20 claims", "PHYS-01", "PHYS-02", "Tests-1198%20passing"],
    },
    "index.html": {
    ...
    "paper.md": {
        "banned": ["389 adversarial", "511 adversarial", "526 adversarial", "544 adversarial", "595 adversarial", "601 adversarial", "906 adversarial", "966 adversarial", "1050 adversarial", "1125 adversarial", "17 March 2026"],
        "required": ["1198 adversarial", "18 March 2026"],
    },
    "reports/known_faults.yaml": {
        ...
        "required": ["1198 tests", "1198 passed"],
    },
    "CLAUDE.md": {
        ...
        "required": ["13-test proof", "8 innovations", "20 claims", "1198 tests"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        "banned": ["271 tests", "295 tests", "526 tests", "544 tests", "595 tests", "601 tests", "906 tests", "966 tests", "1050 tests", "1125 tests", "3 verification layers", "MVP v0.2", "ALL 10 TESTS", "MVP v0.6"],
        "required": ["1198 tests", "5 verification layers", "MVP v0.8", "ALL 13 TESTS"],
    },
