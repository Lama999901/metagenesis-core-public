...
CONTENT_CHECKS = {
    "llms.txt": {
        "banned": ["595 passing", "595 passed", "16 evolution checks", "Claims: 18", "Domains: 7 (", "906 passed", "906 tests", "966 passed", "966 tests", "1050 passed", "1050 tests", "1125 passed", "1125 tests", "1273 passed", "1273 tests", "1313 passed", "1313 tests", "1634 passed", "1634 tests", "1750 passed", "1750 tests", "1753 passed", "1753 tests", "2380 tests", "2063 passed", "2063 tests", "2380 tests", "2078 passed", "2078 tests", "2380 passed", "2380 tests", "2380 passed", "2380 tests", "2407 passed", "2407 tests"],
        "required": ["2423", "v1.0", "20 domain verification templates", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
    ...
    "AGENTS.md": {
        ...
        "required": ["2423", "v1.0.0-rc1", "20 claims", "22 agent checks"],
    },
    "CONTRIBUTING.md": {
        ...
        "required": ["2423", "ALL 13 TESTS", "5 verification layers"],
    },
    "CITATION.cff": {
        ...
        "required": ["version: 1.0", "five independent", "2423"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ARCHITECTURE.md": {
        ...
        "required": ["2423 tests", "Five verification layers"],
    },
    "ppa/README_PPA.md": {
        ...
        "required": ["2423 tests", "8 innovations"],
    },
    "COMMERCIAL.md": {
    ...
    "README.md": {
        ...
        "required": ["2423", "10 Innovations", "22 agent checks", "ALL 22 CHECKS PASSED", "20 claims", "PHYS-01", "PHYS-02", "Tests-2423%20passing"],
    },
    "index.html": {
    ...
    "CLAUDE.md": {
        ...
        "required": ["13-test proof", "8 innovations", "20 claims", "2423 tests", "v1.0.0-rc1"],
    },
    "UPDATE_PROTOCOL.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        ...
        "required": ["2423 tests", "5 verification layers", "MVP v1.0", "ALL 13 TESTS"],
    },
