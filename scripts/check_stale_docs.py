...
CONTENT_CHECKS = {
    "llms.txt": {
        ...
        "required": ["1321", "v0.8", "20 active claims", "PHYS-01", "PHYS-02"],
    },
    "CONTEXT_SNAPSHOT.md": {
    ...
    "AGENTS.md": {
        ...
        "required": ["1321", "v0.8.0", "20 claims", "19 agent checks"],
    },
    "CONTRIBUTING.md": {
    ...
    "CITATION.cff": {
        ...
        "required": ["version: 0.8", "five independent", "1321"],
    },
    "docs/PROTOCOL.md": {
    ...
    "docs/ROADMAP.md": {
        ...
        "required": ["0.8.0", "1321 adversarial"],
    },
    "ppa/README_PPA.md": {
    ...
    "CURSOR_MASTER_PROMPT_v2_3.md": {
        ...
        "required": ["1321 tests", "5 verification layers", "MVP v0.8", "ALL 13 TESTS"],
    },
