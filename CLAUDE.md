...
> Last updated: 2026-03-31 | v0.8.0 LIVE | 20 claims | 651 tests
...
"GPT-5"             → doesn't exist
"100% test success" → "651 tests PASS"
...
python -m pytest tests/ -q           # → 651 passed
...
index.html                  ← site (651 tests/20 claims/5 layers/8 innovations)
